...
const docTemplate = `{
    ...
    "paths": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/models.NotiSetting"
                            }
                        }
                    },
                    "400": {
            ...
            "patch": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.UpdateNotiSettingRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/events/": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "integer",
                        "description": "Number of events per page (default all)",
                        "name": "limit",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "Search in title or city",
                        "name": "search",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "Filter by status: pending, approved, refused",
                        "name": "status",
                        "in": "query"
                    },
                    {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/models.EventsListPagination"
                        }
                    },
                    "400": {
        ...
        "/events/employees/{id}/": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "List of assigned employees",
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/models.AssignedEmployee"
                            }
                        }
                    },
                    "400": {
            ...
            "post": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/models.EventRegistrationResponse"
                        }
                    },
                    "201": {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.AssignEmployeeRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/history/": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Search by admin name or item ID",
                        "name": "search",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "Sort order (most_recent_activity, oldest_activity)",
                        "name": "sort",
                        "in": "query"
                    },
                    {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/models.HistoryListPagination"
                        }
                    },
                    "401": {
                        "description": "Unauthorized",
        ...
        "/listings/{listing_id}/": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Item state (new, good, very_good, need_repair)",
                        "name": "state",
                        "in": "formData",
                        "required": true
                    },
                    {
                        "type": "string",
                        "description": "Item material (wood, metal, textile, glass, plastic, other, mixed)",
                        "name": "material",
                        "in": "formData",
                        "required": true
                    },
                    ...
                    {
                        "type": "string",
                        "description": "Postal code (5-9 digits)",
                        "name": "postal_code",
                        "in": "formData",
                        "required": true
                    },
                    {
                        "type": "string",
                        "description": "Paths of existing images to keep (multiple allowed)",
                        "name": "existing_images",
                        "in": "formData"
                    },
                    {
                        "type": "file",
                        "description": "New images to upload (multiple allowed)",
                        "name": "new_images",
                        "in": "formData"
                    }
                ],
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.VerifyPaymentRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/models.VerifyPaymentResponse"
                        }
                    },
                    "400": {
                        "description": "Invalid payload or session"
                    }
                }
            }
        },
        "/posts/": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Sort by (highest_view, lowest_view, most_recent_creation, oldest_creation, highest_like, lowest_like)",
                        "name": "sort",
                        "in": "query"
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/models.PostListPagination"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/models.PostCountStatsResponse"
                        }
                    },
                    "401": {
                        "description": "Unauthorized",
                    ...
                    "500": {
                        "description": "Failed to get stats of posts",
                        "schema": {
                            "type": "string"
                        }
                    }
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "collectionFormat": "csv",
                        "description": "Image paths to keep",
                        "name": "existing_images",
                        "in": "formData"
                    },
                    {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/models.PostCommentsResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
    ...
    "definitions": {
        ...
        "models.EventRegistrationResponse": {
            "type": "object",
            "properties": {
                "checkout_url": {
                    "type": "string"
        ...
        "models.Item": {
            ...
            "properties": {
                "category": {
                    "description": "listing or deposit",
                    "type": "string"
                },
                "created_at": {
                    "type": "string"
        ...
        "models.UpdateNotiSettingRequest": {
            "type": "object",
            "properties": {
                "is_enabled": {
                    "type": "boolean"
