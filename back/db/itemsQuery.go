...
func GetPendingDeposits(page, limit int, filters ValidationFilters) ([]models.PendingDepositResponse, int, error) {
...
// page=-1 and limit=-1 returns all records.
func GetPendingListings(page, limit int, filters ValidationFilters) ([]models.PendingListingResponse, int, error) {
	var params []interface{}
	var countParams []interface{}
	paramIndex := 1
...
// page=-1 and limit=-1 returns all records.
func GetPendingEvents(page, limit int, filters ValidationFilters) ([]models.PendingEventResponse, int, error) {
	var params []interface{}
	var countParams []interface{}
	paramIndex := 1
