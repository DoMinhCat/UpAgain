...
func GetPostRoutes(mux *http.ServeMux) {
	...
	mux.Handle("DELETE /posts/{id_post}/delete", middleware.AuthMiddleware([]string{"admin", "pro", "employee", "user"}, middleware.UpdateLastActive(http.HandlerFunc(controllers.DeletePost))))
