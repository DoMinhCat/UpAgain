...
func GetDepositRoutes(mux *http.ServeMux) {
	...
	mux.Handle("PATCH /deposits/{deposit_id}/transfer", middleware.AuthMiddleware([]string{"user", "admin"}, middleware.UpdateLastActive(http.HandlerFunc(controllers.TransferContainerByDepositId))))
}
